    ...
    <div>
      ...
      <section className="relative bg-gradient-to-r from-primary to-orange-700 text-white">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1739066598673-c81259c52277?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHwxfHxpbmRpYW4lMjBlY29tbWVyY2UlMjBzaG9wcGluZyUyMHdlYnNpdGUlMjBiYW5uZXIlMjBkaXdhbGklMjBzYWxlfGVufDB8fHx8MTc1MTAxMjczNHww&ixlib=rb-4.1.0&fit=fillmax&h=400&w=1200"
